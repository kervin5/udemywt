                ...
                <div id="top-social">
                    <ul>
	                    ...
	                    <?php if(get_theme_mod('ju_telephone_handle')):?>
                            <li><a href="tel:<?php echo get_theme_mod('ju_telephone_handle');?>" class="si-call"><span class="ts-icon"><i class="icon-call"></i></span><span class="ts-text"><?php echo get_theme_mod('ju_telephone_handle');?></span></a></li>
	                    <?php endif;?>
                        ...
                        <div id="top-cart">
                            ...
                            <div class="top-cart-content">
                                ...
                                <div class="top-cart-action clearfix">
                                    <span class="fleft top-checkout-price"><?php echo WC()->cart->get_cart_contents_total();?></span>
                                    <a href="<?php wp_get_cart_url();?>" class="button button-3d button-small nomargin fright">View Cart</a>
                                </div>
                            </div>
                        </div><!-- #top-cart end -->
	                <?php endif;?>
				  ...
				  ============================================= -->
                        <div id="top-search">
                            ...
                            <form action="<?php echo esc_url(home_url('/'));?>" method="get">
                                <input type="text" name="q" class="form-control" value="<?php the_search_query();?>"
